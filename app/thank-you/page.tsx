    ...
    >
      ...
      <div className="container relative z-10">
        <div className="mx-auto max-w-[980px] border-y border-black/15 py-10 md:py-14 xl:py-18">
          <p className="text-19 font-light text-paragraph">Application received</p>
          ...
          <p className="mt-6 max-w-[62ch] text-19 font-light leading-[1.7] text-paragraph">
            Your application has been received. Our procurement team will
            review it within 5–7 working days and contact you.
          </p>
